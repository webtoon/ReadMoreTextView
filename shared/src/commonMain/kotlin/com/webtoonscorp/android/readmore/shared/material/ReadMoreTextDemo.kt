 ...
 */
package com.webtoonscorp.android.readmore.shared.material
...
@Composable
internal fun ReadMoreTextDemo(upPress: (() -> Unit)? = null) {
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = {
                    Text(text = StringResources.compose_material_title)
                }
            )
        },
        content = {
